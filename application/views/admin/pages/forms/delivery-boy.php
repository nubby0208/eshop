            ...
            <form class="form-horizontal form-submit-event" action="<?= base_url('admin/delivery_boys/add_delivery_boy'); ?>" method="POST" id="add_product_form">
              ...
              <div class="card-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="number" class="form-control" id="bonus" placeholder="Enter Bonus(%) to be given to the delivery boy on successful order delivery" name="bonus" value="<?= @$fetched_data[0]['bonus'] ?>">
                  </div>
                </div>
