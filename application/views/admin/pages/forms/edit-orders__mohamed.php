                    ...
                    <div class="card card-info">
                        <div class="card-body">
                            <table class="table">
                                ...
                                <form action="<?= base_url('admin/orders/doUpdateOrder'); ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control" id="tracking_number" placeholder="Tracking Number" name="tracking_number" value="">
                                    </td>
                                </tr>
