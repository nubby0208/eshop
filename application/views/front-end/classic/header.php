                                    ...
                                    <ul class="nav vertical-nav menu" itemscope itemtype="https://schema.org/BreadcrumbList">
                                        ...
                                        ?>
                                                ...
                                                <li class="category-span">
                                                    ...
                                                    <?php foreach ($this->category_model->get_table_data('categories', array('parent_id' => $row['id'] ) ) as $subcat):  ?>

                                                        <li class="category-span">
                                                            <a itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem" itemprop="item" href="<?= base_url('products/category/' . $subcat->slug) ?>">
                                                                <img class="svg-icon-image lazy" data-src="<?= base_url($subcat->image) ?>" />
                                                                <span class="category-line-height" itemprop="name"><?=$subcat->name?></span>
                                                                <span class="d-none" itemprop="item"> <?= base_url('products/category/' . $subcat->slug) ?></span>
                                                                <meta itemprop="position" content="<?= $count ?>" />
                                                            </a>
                                                        </li>
