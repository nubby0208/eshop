...
class Return_request_model extends CI_Model
{
    ...
    function get_return_request_list()
    {
        ...
        foreach ($offer_search_res as $row) {
            ...
            $operate = '<a href="javascript:void(0)" class="edit_request btn btn-success btn-xs mr-1 mb-1" title="Edit" data-target="#request_rating_modal" data-toggle="modal" ><i class="fa fa-pen"></i></a>';
